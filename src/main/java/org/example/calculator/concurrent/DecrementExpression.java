...
class DecrementExpression extends Expression {
    ...
    public DecrementExpression(String variableName, boolean isPrefix, Map<String, Long> variables) {
    ...
    public Set<String> getDependencies() {
        return Collections.singleton(variableName); // Depends on the decremented variable
    }
}
